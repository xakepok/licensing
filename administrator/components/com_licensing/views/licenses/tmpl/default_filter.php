    ...
    <div class="js-stools-container-bar">
        ...
        <div class="btn-wrapper input-append">
            <input type="text" autocomplete="off" name="filter_search" id="filter_search"
                   ...
                   title aria-label="<?php echo JText::_('COM_LICENSING_FILTER_LICENSE'); ?>"
                   data-original-title="<?php echo JText::_('COM_LICENSING_FILTER_LICENSE'); ?>"
                   placeholder="<?php echo JText::_('COM_LICENSING_FILTER_LICENSE'); ?>"
            >
